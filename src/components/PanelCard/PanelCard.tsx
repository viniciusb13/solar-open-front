...
const PanelCard = ({ panelName, panelHealth, currentEnergy, operatingPeriod }: PanelCardProps) => {
    return (
        <div className='w-full px-16 py-8 rounded-[32px] bg-white bg-opacity-5 flex flex-col justify-center items-center'>
            <h4 className="text-5xl font-medium mb-8">{panelName}</h4>
            <div className="bg-white bg-opacity-15 rounded-3xl py-1 px-3 flex items-center gap-3 text-2xl">
            ...
            <div className="w-full flex justify-evenly gap-4">
                <div>
                    <h5 className="text-3xl">Energia Atual</h5>
                    <div className="mt-2 text-3xl font-bold py-2 text-center bg-white bg-opacity-15 rounded-3xl">
                        {currentEnergy} kwh
                    </div>
                </div>
                <div>
                    <h5 className="text-3xl">Saúde do Painel</h5>
                    <div className="mt-2 text-3xl font-bold py-2 text-center bg-white bg-opacity-15 rounded-3xl">
                        {panelHealth}%
                    </div>
                </div>
