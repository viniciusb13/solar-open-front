                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="emailAddress"
                      id="emailAddress"
                      placeholder="fausto_silva@globo.com"
                      defaultValue="fausto_silva@globo.com"
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="mt-2.5 text-body-sm font-medium">
                      <span className="text-primary">Escolher arquivo</span> ou
                      arraste aqui
                    </p>
...
export default UserSettingBoxes;
