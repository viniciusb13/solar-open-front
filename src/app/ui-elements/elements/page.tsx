...
import CloseMarks from "@/components/CloseMarks/CloseMark";
  ...
  return (
    <DefaultLayout>
      ...
      <div className="mb-10 rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-4 md:p-6 xl:p-9 flex justify-evenly">
          <div className="mb-7.5 flex flex-col gap-3 justify-center items-center">
            <h3>Close Mark</h3>
            <CloseMarks />
          </div>
